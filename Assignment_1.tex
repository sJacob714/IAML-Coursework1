...
\newcommand{\assignmentDueDate}{Tues,\ October\ 18,\ 2021 @ 16:00}
%--------------------------------------------------------
...
%
%
\begin{subquestion}{Describe the main properties of the data in the file \texttt{linear\_regression\_data.csv}, focusing on the size, data ranges, and data types.   
}
...
Report the MSE of the data in \texttt{linear\_regression\_data.csv} for your prediction of \texttt{exam\_score}.
